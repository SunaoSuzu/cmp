        ...
        <div style={{ width: "100%" }}>
            ...
            <Grid container spacing={1}>
                {def.schema.fields.map( field => {
                    if( field.type === "list"){
                        return <ChildTable field={field} name={field.field} data={data} handleChange={handleChange} />
                    }else{
                        return <Field field={field} name={field.field} data={data} handleChange={handleChange} />
                    }
                })}
            </Grid>
        </div>
